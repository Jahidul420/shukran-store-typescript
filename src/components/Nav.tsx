...
const navigation = [
  ...
  { name: "Contact", href: "/contact", dropDownIcon: false, current: false },
];
...
const Nav = (props: Props) => {
  ...
  const [cartProducts, setCartProducts] = useState(productsArr);
              ...
              <div className="relative flex items-center justify-between h-14 md:h-16">
                ...
                <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                  <div className="flex-shrink-0 flex items-start sm:items-center">
                    <Link to="/" className=" h-14 w-14 flex items-center">
                      <img
                        src={logo}
                        alt=""
                        className=" bg-cover
