...
const Profile = () => {
  ...
  return (
    <div>
      <Nav />
      <div className="w-full h-auto -mt-16 bg-gray-100 pb-12">
    ...
    <>
      ...
      <div className=" w-[90vw] h-auto flex justify-between py-4 mx-auto relative bg-gray-100">
        <div className=" relative flex w-3/6">
          ...
          <div className=" text ml-8 text-sm font-medium text-gray-600 space-y-1">
            <div className="flex items-center gap-2">
              <h2 className=" text-2xl mb-2 font-bold">JAHIDUL ISLAM </h2>
            </div>
            <p>01234567899</p>
            <p>Join Date: 30/12/22</p>
            <button className=" flex items-center gap-2" onClick={click}>
              <FiEdit /> Edit Profile
            </button>
          </div>
        </div>
        ...
        <div className="w-3/6 px-10 py-8 h-full bg-white rounded-lg flex flex-col justify-between">
          ...
          {showMap ? (
            ...
            <div className=" h-[90%] w-full">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d9468.852288507544!2d90.41338834611648!3d23.792215989152826!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1670938718636!5m2!1sen!2sbd"
                width="100%"
                height="100%"
                style={{ border: "0" }}
